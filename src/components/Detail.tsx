...
const Detail = () => {
  ...
  useEffect(() => {
    switch (category) {
      case "recommend":
        setDetailData(
          allMovies.recommend?.find((value) => value.id === id) as Movie
        );
        break;
      case "trending":
        setDetailData(
          allMovies.trending?.find((value) => value.id === id) as Movie
        );
        break;
      case "original":
        setDetailData(
          allMovies.original?.find((value) => value.id === id) as Movie
        );
        break;
      case "new":
        setDetailData(allMovies.new?.find((value) => value.id === id) as Movie);
        break;
    }
  }, []);
